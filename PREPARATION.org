* Description
  We, the Boba Team, used this file to gather notes and resources in
  preparation for the S3 Server Hackathon with Scality and Seagate,
  hosted at Holberton School.

  Below you can find the source code map we made to break down the
  source code of the S3 server [[https://github.com/TeamBoba/S3][(link to our fork)]]; a compilation of
  the resources we used; and a summary of what we covered for each day
  of preparation leading to the hackathon on October 21st, 2016.

  We, members of the Boba Team -- Daniel Alzugaray, Electra Chong,
  Rona Chong (and unofficial team member Josquin Gaillard) -- [not
  sure what Daniel had in mind to write here]
...
* Day 6
** Proposed items for development
   Rona outlined a development trajectory for our team, which can be
   found in [[https://github.com/dalzuga/s3hackathon/blob/master/DEVELOPMENT.org][DEVELOPMENT.org]].
